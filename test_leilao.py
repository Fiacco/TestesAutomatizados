...
class TestLeilao(TestCase):
    ...
    def test_test_deve_retornar_o_maior_e_o_menor_valor_de_um_lance_quando_adicionado_em_ordem_decrescente(self):
        self.leilao.propoe(self.lance_do_gui)
    ...
    # se o ultimo usuario for difertente , deve permitir propor o lance

    def tes_deve_permitir_propor_um_lance_caso_o_ultimo_usuario_seja_diferente(self):
        yuri = Usuario('yuri')
